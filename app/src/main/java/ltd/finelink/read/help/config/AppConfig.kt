...
object AppConfig : SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    var storeGroupStyle: Int
        get() = appCtx.getPrefInt(PreferKey.storeGroupStyle, 0)
        set(value) {
            appCtx.putPrefInt(PreferKey.storeGroupStyle, value)
        }

    var voiceStoreLayout: Int
        get() = appCtx.getPrefInt(PreferKey.voiceStoreLayout, 0)
        set(value) {
            appCtx.putPrefInt(PreferKey.voiceStoreLayout, value)
        }
    ...
    val showVoiceStore: Boolean
        get() = appCtx.getPrefBoolean(PreferKey.showVoiceStore, true)
    ...
    val volumeKeyPage
        get() = appCtx.getPrefBoolean(PreferKey.volumeKeyPage, false)
    ...
    var voiceStoreSort: Int
        get() = appCtx.getPrefInt(PreferKey.voiceStoreSort, 0)
        set(value) {
            appCtx.putPrefInt(PreferKey.voiceStoreSort, value)
        }
