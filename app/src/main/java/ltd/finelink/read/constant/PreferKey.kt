...
object PreferKey {
    ...
    const val storeGroupStyle = "storeGroupStyle"
    ...
    const val showVoiceStore = "showVoiceStore"
    const val enableReview = "enableReview"
    const val showRss = "showRss"
    const val bookshelfLayout = "bookshelfLayout"
    const val bookshelfSort = "bookshelfSort"
    const val voiceStoreLayout = "voiceStoreLayout"
    const val voiceStoreSort = "voiceStoreSort"
