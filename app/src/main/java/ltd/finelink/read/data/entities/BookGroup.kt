...
data class BookGroup(
    ...
    fun getDefaultName(context: Context): String {
        return when (groupId) {
            IdAll -> "${context.getString(R.string.all)}"
            IdAudio -> "${context.getString(R.string.audio)}"
            IdLocal -> "${context.getString(R.string.local)}"
            IdNetNone -> "${context.getString(R.string.net_no_group)}"
            IdLocalNone -> "${context.getString(R.string.local_no_group)}"
            IdError -> "${context.getString(R.string.update_book_fail)}"
            else -> groupName
        }
    }
