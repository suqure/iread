...
class ImportLocalTtsDialog() : BaseDialogFragment(R.layout.dialog_recycler_view),
    CodeDialog.Callback {
    ...
    private val viewModel by viewModels<ImportLocalTtsViewModel>()
    ...
    override fun onFragmentCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.toolBar.setTitle(R.string.import_model)
    ...
    inner class SourcesAdapter(context: Context) :
        RecyclerAdapter<LocalTTS, ItemSourceImportBinding>(context) {
    ...
    override fun onCodeSave(code: String, requestId: String?) {
        requestId?.toInt()?.let {
            LocalTTS.fromJson(code).getOrNull()?.let { source ->
