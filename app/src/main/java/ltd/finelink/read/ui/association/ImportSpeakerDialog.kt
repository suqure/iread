...
class ImportSpeakerDialog() : BaseDialogFragment(R.layout.dialog_recycler_view),
    CodeDialog.Callback {
    ...
    private val viewModel by viewModels<ImportSpeakerViewModel>()
    ...
    override fun onFragmentCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.toolBar.setTitle(R.string.import_voice)
    ...
    inner class SourcesAdapter(context: Context) :
        RecyclerAdapter<TTSSpeaker, ItemSourceImportBinding>(context) {
    ...
    override fun onCodeSave(code: String, requestId: String?) {
        requestId?.toInt()?.let {
            TTSSpeaker.fromJson(code).getOrNull()?.let { source ->
